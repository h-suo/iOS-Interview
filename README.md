...
- [컴퓨터 구조와 관련하여 CPU, RAM, 저장장치의 역할과 상호 작용에 대해 설명해주세요.](https://github.com/h-suo/Interview/blob/main/content/24.05.26.md)
  ...
  - [CPU 아키텍처의 종류(예: ARM, x86)와 특징에 대해 설명해주세요.](https://github.com/h-suo/Interview/blob/main/content/24.05.27.md)
...
- [App thinning에 대해서 설명하시오.](https://github.com/h-suo/iOS-Interview/blob/main/content/24.04.02.md)
- [앱이 시작할 때 main.c 에 있는 UIApplicationMain 함수에 의해서 생성되는 객체는 무엇인가?](https://github.com/h-suo/iOS-Interview/blob/main/content/24.03.26.md)
